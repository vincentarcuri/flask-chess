from chessv2.chess_logic import *
...
class PieceLoader:
    ...
    @staticmethod
    def load_white_castle_short():
        """https://lichess.org/editor/k7/8/8/8/8/8/8/4K2R_w_-_-_0_1?color=white"""
        pieces = [
            King('e1', True),
            Rook('h1', True),
            King('a8', False),
    ...
    @staticmethod
    def load_black_castle_long():
        """https://lichess.org/editor/r3k3/8/8/8/8/8/8/7K_w_-_-_0_1?color=white"""
